...
2026-09-23 우선순위 갱신(D49): 투구 전에는 대표 구종·목표 위치를 우선하며 후보별 수치 비교·이유 표시는 후순위다. 투구 후 실제 비교와 중요 사건 후 기여 비중·근거는 필수다. CV는 팀원 전담이고 서비스는 기존 의도 계약으로 소비한다. 아래 초기 설계의 개발 순서보다 [현재 로드맵](roadmap.md)과 [병렬 업무 계획](plan.md)을 우선한다.
