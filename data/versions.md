...
- `pyarrow 버전`·`수집 상한일` 열은 2026-09-12 이후 행부터 기록. 그 전 행(9열)은 빈 칸으로 읽힌다 (manifest.json 참조)

| 버전 ID | 시즌 | 파일 | 날짜 범위 | 행 수 | parquet sha256 | pybaseball 버전 | 수집 커밋 | frozen | pyarrow 버전 | 수집 상한일 |
|---|---|---|---|---|---|---|---|---|---|---|
