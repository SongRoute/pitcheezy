...
| MX-D2 | 후속 | 활성화·세부 실행기 준비 | D1의 D25도 D100 auxiliary를 공유했으므로 전체 TRAIN 적합 정보량 효과를 분리; 결과 전 별도 등록 필요 |
...
| MX-T2 | 필수 | 제외 fold 실행기/synthetic 준비·G선정 대기 | 선수·리그통계 재구성, 공통Z/W/O행과 고정노출prefix |
