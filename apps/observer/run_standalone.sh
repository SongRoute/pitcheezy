...
export PITCHEEZY_OBSERVER_RUNTIME=standalone
export PITCHEEZY_OBSERVER_PYTHON="$OBSERVER_ROOT/.venv-observer-standalone/bin/python"
export PITCHEEZY_OBSERVER_RUN="${PITCHEEZY_OBSERVER_RUN:-/Volumes/T7 Shield/pitcheezy/pitchmdp/runs/observer-improvement-v2}"
export PITCHEEZY_OBSERVER_PORT="${PITCHEEZY_OBSERVER_PORT:-8768}"
